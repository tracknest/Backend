...
export const signupTemplate = (firstName) => baseTemplate(`
...
export const loginTemplate = (firstName, loginTime, ipAddress) => baseTemplate(`
...
export const otpTemplate = (firstName, otp, expiresInMinutes = 10) => baseTemplate(`
...
export const forgotPasswordTemplate = (firstName, resetUrl) => baseTemplate(`
...
export const resetPasswordSuccessTemplate = (firstName) => baseTemplate(`
...
export const logoutTemplate = (firstName, logoutTime) => baseTemplate(`
