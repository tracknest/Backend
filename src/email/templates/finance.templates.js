...
const formatDate = (date) => (date ?? new Date()).toLocaleString("en-NG", {
    dateStyle: "medium",
    timeStyle: "short",
});
// ─── Main Account ────────────────────────────────────────────────────────────
export const depositTemplate = (firstName, amount, newBalance, ref) => baseTemplate(`
...
export const withdrawalTemplate = (firstName, amount, newBalance, ref) => baseTemplate(`
...
// ─── Budget ───────────────────────────────────────────────────────────────────
export const budgetAddedTemplate = (firstName, budgetName, limit) => baseTemplate(`
...
export const budgetRemovedTemplate = (firstName, budgetName) => baseTemplate(`
...
export const budgetDepositTemplate = (firstName, budgetName, amount, budgetBalance) => baseTemplate(`
...
export const budgetWithdrawTemplate = (firstName, budgetName, amount, mainBalance) => baseTemplate(`
...
// ─── Goal ─────────────────────────────────────────────────────────────────────
export const goalAddedTemplate = (firstName, goalName, targetAmount, deadline) => baseTemplate(`
...
export const goalRemovedTemplate = (firstName, goalName) => baseTemplate(`
...
export const goalDepositTemplate = (firstName, goalName, amount, savedSoFar, targetAmount) => {
...
export const goalWithdrawTemplate = (firstName, goalName, amount, mainBalance) => baseTemplate(`
...
//# sourceMappingURL=finance.templates.js.map